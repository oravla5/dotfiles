...
local function lsp_keymaps(bufnr)
    ...
    -- Elements navigation
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", "<cmd>lua vim.lsp.buf.declaration()<CR>", opts) -- *g*o to *d*eclaration
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gD", "<cmd>lua vim.lsp.buf.definition()<CR>", opts) -- *g*o to *D*efinitions (definitions are larger than declarations)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<C-p>", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>',
        opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<C-n>", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>',
        opts)
