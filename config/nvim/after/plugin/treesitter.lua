...
configs.setup {
    ensure_installed = { "bash", "c", "cpp", "javascript", "typescript", "json", "lua", "python", "tsx", "css", "yaml", "markdown", "markdown_inline" },    -- one of 'all', 'maintained' (parsers with maintainers), or a list of languages
